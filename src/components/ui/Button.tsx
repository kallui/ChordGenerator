...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", ...props }, ref) => {
    ...
    const variants = {
      default:
        "bg-slate-900 text-slate-50 hover:bg-slate-800 focus-visible:ring-slate-300",
      secondary:
        "bg-slate-200 text-slate-900 hover:bg-slate-300 focus-visible:ring-slate-200",
      outline:
        "border border-slate-200 bg-white hover:bg-slate-50 focus-visible:ring-slate-200",
